...
- O Meu Cartãozinho gera uma única receita prevista por mês, somando o valor a receber de todas as pessoas. A sincronização é idempotente e não recria os lançamentos individuais antigos.
