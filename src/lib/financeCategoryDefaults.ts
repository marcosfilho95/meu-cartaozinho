...
const PARENTS: ParentDef[] = [
  ...
  { name: "Alimentacao", kind: "expense", color: "#FF6B6B", icon: "utensils" },
  { name: "Transporte", kind: "expense", color: "#4ECDC4", icon: "car" },
  { name: "Saude", kind: "expense", color: "#96CEB4", icon: "heart" },
  { name: "Educacao", kind: "expense", color: "#FFEAA7", icon: "book-open" },
  ...
  { name: "Salario", kind: "income", color: "#2ECC71", icon: "banknote" },
  { name: "Renda Extra", kind: "income", color: "#27AE60", icon: "briefcase" },
  { name: "Investimentos", kind: "income", color: "#1ABC9C", icon: "trending-up" },
  { name: "Transferencias", kind: "transfer", color: "#85929E", icon: "arrow-right-left" },
];

const CHILDREN: ChildDef[] = [
  { name: "Aluguel", kind: "expense", parent: "Casa", color: "#45B7D1", icon: "home" },
  { name: "Condominio", kind: "expense", parent: "Casa", color: "#45B7D1", icon: "home" },
  { name: "Energia", kind: "expense", parent: "Casa", color: "#45B7D1", icon: "sparkles" },
  { name: "Agua", kind: "expense", parent: "Casa", color: "#45B7D1", icon: "sparkles" },
  { name: "Internet", kind: "expense", parent: "Casa", color: "#45B7D1", icon: "wifi" },
  { name: "Mercado", kind: "expense", parent: "Alimentacao", color: "#FF6B6B", icon: "shopping-cart" },
  { name: "Restaurante", kind: "expense", parent: "Alimentacao", color: "#FF6B6B", icon: "utensils" },
  { name: "Delivery", kind: "expense", parent: "Alimentacao", color: "#FF6B6B", icon: "coffee" },
  { name: "Gasolina", kind: "expense", parent: "Transporte", color: "#4ECDC4", icon: "car" },
  { name: "Uber e Taxi", kind: "expense", parent: "Transporte", color: "#4ECDC4", icon: "car" },
  { name: "Transporte Publico", kind: "expense", parent: "Transporte", color: "#4ECDC4", icon: "car" },
  { name: "Farmacia", kind: "expense", parent: "Saude", color: "#96CEB4", icon: "heart" },
  { name: "Consultas", kind: "expense", parent: "Saude", color: "#96CEB4", icon: "heart" },
  { name: "Exames", kind: "expense", parent: "Saude", color: "#96CEB4", icon: "heart" },
  { name: "Cursos", kind: "expense", parent: "Educacao", color: "#FFEAA7", icon: "book-open" },
  { name: "Livros", kind: "expense", parent: "Educacao", color: "#FFEAA7", icon: "book-open" },
  ...
  { name: "Bonus", kind: "income", parent: "Renda Extra", color: "#27AE60", icon: "sparkles" },
  ...
  { name: "Entre Contas", kind: "transfer", parent: "Transferencias", color: "#85929E", icon: "arrow-right-left" },
];
