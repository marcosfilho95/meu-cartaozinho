...
const PARENTS: ParentDef[] = [
  ...
  { name: "Vestuário", kind: "expense", color: "#F0B27A", icon: "shirt" },
  { name: "Cuidados Pessoais", kind: "expense", color: "#F9A8D4", icon: "sparkles" },
  { name: "Compras", kind: "expense", color: "#C4B5FD", icon: "shopping-bag" },
  { name: "Pet", kind: "expense", color: "#FCA5A5", icon: "heart" },
...
const CHILDREN: ChildDef[] = [
  ...
  { name: "Cinema", kind: "expense", parent: "Lazer", color: "#DB2777", icon: "gamepad-2" },
  { name: "Bares", kind: "expense", parent: "Lazer", color: "#F43F5E", icon: "coffee" },
  { name: "Hobbies", kind: "expense", parent: "Lazer", color: "#E879F9", icon: "gamepad-2" },
  { name: "Roupas", kind: "expense", parent: "Vestuário", color: "#FB923C", icon: "shirt" },
  { name: "Calçados", kind: "expense", parent: "Vestuário", color: "#EA8A5E", icon: "shirt" },
  { name: "Acessórios", kind: "expense", parent: "Vestuário", color: "#F59E0B", icon: "shirt" },
  { name: "Cabeleireiro", kind: "expense", parent: "Cuidados Pessoais", color: "#F472B6", icon: "sparkles" },
  { name: "Cosméticos", kind: "expense", parent: "Cuidados Pessoais", color: "#EC4899", icon: "sparkles" },
  { name: "Perfumaria", kind: "expense", parent: "Cuidados Pessoais", color: "#F9A8D4", icon: "sparkles" },
  { name: "Compras Online", kind: "expense", parent: "Compras", color: "#A78BFA", icon: "shopping-bag" },
  { name: "Eletrônicos", kind: "expense", parent: "Compras", color: "#818CF8", icon: "shopping-bag" },
  { name: "Casa e Decoração", kind: "expense", parent: "Compras", color: "#C4B5FD", icon: "home" },
  { name: "Pet Shop", kind: "expense", parent: "Pet", color: "#FCA5A5", icon: "heart" },
  { name: "Veterinário", kind: "expense", parent: "Pet", color: "#F87171", icon: "heart" },
