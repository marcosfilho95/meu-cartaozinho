CREATE OR REPLACE FUNCTION public.confirm_financial_import(p_file jsonb, p_import jsonb, p_transactions jsonb)
RETURNS jsonb
LANGUAGE plpgsql
...
begin
  ...
  ON CONFLICT (user_id, file_hash) WHERE file_hash <> ''
